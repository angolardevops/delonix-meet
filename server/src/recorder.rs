...
async fn finalize_inner(
    ...
    // de sempre; vem da reunião agendada quando a sala nasceu de uma. O
    // `format` da sala dá o `kind` da gravação (R183).
    let (code, format, quality): (String, String, Option<String>) =
