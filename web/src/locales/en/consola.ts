...
export default {
  ...
  ramais: {
    ...
    novo: 'New extension',
    membro: 'Person',
    escolherMembro: 'Choose a person…',
    semMembrosDisponiveis: 'Everyone in this organisation already has an extension, or there is no one left to assign.',
    extensao: 'Extension number',
    extensaoPh: 'E.g.: 101',
    rotulo: 'Label (optional)',
    rotuloPh: 'E.g.: Support',
    criar: 'Create extension',
    erroCriar: 'Could not create the extension.',
    erroCarregar: 'Could not load the extensions.',
    regenerar: 'Regenerate password',
    regenerarConfirmar: 'Generate a new SIP password for extension {{extensao}}? The previous one stops working.',
    apagar: 'Delete',
    apagarConfirmar: 'Delete extension {{extensao}}? Its SIP account will no longer be able to register.',
    desactivar: 'Deactivate',
    activar: 'Reactivate',
    credenciaisTitulo: 'SIP credentials — shown only now',
    credenciaisAviso: 'Copy this into the softphone now: this password will not be shown again, only its hash is kept.',
