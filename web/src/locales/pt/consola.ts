...
export default {
  ...
  ramais: {
    ...
    novo: 'Novo ramal',
    membro: 'Pessoa',
    escolherMembro: 'Escolher pessoa…',
    semMembrosDisponiveis: 'Todas as pessoas desta organização já têm ramal, ou não há pessoas por atribuir.',
    extensao: 'Número do ramal',
    extensaoPh: 'Ex.: 101',
    rotulo: 'Rótulo (opcional)',
    rotuloPh: 'Ex.: Suporte',
    criar: 'Criar ramal',
    erroCriar: 'Não foi possível criar o ramal.',
    erroCarregar: 'Não foi possível carregar os ramais.',
    regenerar: 'Regenerar password',
    regenerarConfirmar: 'Gerar uma password SIP nova para o ramal {{extensao}}? A anterior deixa de servir.',
    apagar: 'Apagar',
    apagarConfirmar: 'Apagar o ramal {{extensao}}? A conta SIP deixa de poder registar-se.',
    desactivar: 'Desactivar',
    activar: 'Reactivar',
    credenciaisTitulo: 'Credenciais SIP — só aparecem agora',
    credenciaisAviso: 'Copia para o softphone agora: esta password não volta a aparecer, só fica guardado o hash.',
