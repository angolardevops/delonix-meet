...
export default {
  ...
  ramais: {
    ...
    novo: 'Nouveau poste',
    membro: 'Personne',
    escolherMembro: 'Choisir une personne…',
    semMembrosDisponiveis: "Toutes les personnes de cette organisation ont déjà un poste, ou il n'y a personne à assigner.",
    extensao: 'Numéro du poste',
    extensaoPh: 'Ex. : 101',
    rotulo: 'Étiquette (facultatif)',
    rotuloPh: 'Ex. : Support',
    criar: 'Créer le poste',
    erroCriar: 'Impossible de créer le poste.',
    erroCarregar: 'Impossible de charger les postes.',
    regenerar: 'Régénérer le mot de passe',
    regenerarConfirmar: "Générer un nouveau mot de passe SIP pour le poste {{extensao}} ? L'ancien cesse de fonctionner.",
    apagar: 'Supprimer',
    apagarConfirmar: "Supprimer le poste {{extensao}} ? Son compte SIP ne pourra plus s'enregistrer.",
    desactivar: 'Désactiver',
    activar: 'Réactiver',
    credenciaisTitulo: 'Identifiants SIP — affichés seulement maintenant',
    credenciaisAviso: "Copie-le dans le softphone maintenant : ce mot de passe ne sera plus jamais affiché, seul son hachage est conservé.",
