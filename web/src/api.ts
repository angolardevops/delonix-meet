...
/**
 * `GET /api/orgs/{org}/audit-events/verification` — recalcula a cadeia de hashes do registo
...
/** Encerrar corta a chamada a todos os participantes PSTN. Responde `204`, sem corpo. */
...
/** Campos que `GET /api/orgs/{id}/members` acrescenta a cada `Employee`. */
