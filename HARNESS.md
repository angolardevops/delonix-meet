...
- `recording_chapters.rs` — capítulos manuais e automáticos (LLM local via `ai::generate`, a partir dos segmentos; varredura de 5 em 5 min); gerar de novo nunca apaga os manuais (G5)
